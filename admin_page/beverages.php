        ...
        <div class="col-lg-12">
            ...
            <div class="c ard">
                <div class="card-body">
                    ...
                    <!-- Btn Add Data -->
                    <div class="mb-3">
                        <a href="index.php?page=beverages_create&op=create" class="btn btn-primary" type="submit">
                            <span>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="d-inline">
                                        <a href="index.php?page=beverages_edit&op=edit&id=<?= $data['id'] ?>" class="btn btn-warning">
                                            <span>
                                                <i class="bi bi-pencil"></i>
                                            </span>
                                        </a>
                                        <a href="index.php?page=beverages&op=delete&id=<?= $data['id']; ?>" class="btn btn-danger">
                                            <span>
